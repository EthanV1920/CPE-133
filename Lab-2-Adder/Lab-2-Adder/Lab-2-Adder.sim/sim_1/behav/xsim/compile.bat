...
REM
REM Generated by Vivado on Wed Oct 11 22:24:14 -0700 2023
...
echo "xvlog --incr --relax -L uvm -prj RLC_TB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj RLC_TB_vlog.prj -log xvlog.log
