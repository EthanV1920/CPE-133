...
HD_PWD='Z:/Documents/git/CPE-133/Lab-2-Adder/Lab-2-Adder/Lab-2-Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RLC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RLC.tcl -notrace
