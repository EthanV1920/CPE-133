...
HD_PWD='Z:/Documents/git/CPE-133/Lab-2-Adder/Lab-2-Adder/Lab-2-Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RLC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RLC.tcl
