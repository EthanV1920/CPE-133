...
HD_PWD='Z:/Documents/git/CPE-133/Lab-1-Lock-Box/CPE_133_Lab_1/CPE_133_Lab_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FLC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FLC.tcl -notrace
