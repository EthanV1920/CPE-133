...
HD_PWD='Z:/Documents/git/CPE-133/Lab-1-Lock-Box/CPE_133_Lab_1/CPE_133_Lab_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FLC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FLC.tcl
