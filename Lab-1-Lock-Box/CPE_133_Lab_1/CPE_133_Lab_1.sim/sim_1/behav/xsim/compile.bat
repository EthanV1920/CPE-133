...
REM
REM Generated by Vivado on Tue Oct 03 18:35:30 -0700 2023
...
echo "xvlog --incr --relax -L uvm -prj FLC_TB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj FLC_TB_vlog.prj -log xvlog.log
