...
HD_PWD='Z:/Documents/git/CPE-133/Lab-3-Segment-Adder/Lab-3-Segment-Adder/Lab-3-Segment-Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SEGMENT_ADDER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SEGMENT_ADDER.tcl
