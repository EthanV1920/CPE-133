...
HD_PWD='Z:/Documents/git/CPE-133/Lab-3-Segment-Adder/Lab-3-Segment-Adder/Lab-3-Segment-Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SEGMENT_ADDER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SEGMENT_ADDER.tcl -notrace
