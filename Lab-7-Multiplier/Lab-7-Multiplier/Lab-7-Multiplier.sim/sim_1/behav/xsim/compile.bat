...
REM
REM Generated by Vivado on Sat Dec 02 01:09:22 -0800 2023
...
echo "xvlog --incr --relax -L uvm -prj Multiplier_TB_vlog.prj"
call xvlog  --incr --relax -L uvm -prj Multiplier_TB_vlog.prj -log xvlog.log
